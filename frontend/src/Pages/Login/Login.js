...
export const Login = () => {
  ...
  return (
    <div class="flex flex-col justify-center items-center h-screen">
      ...
      <input id="email" class="w-64 h-10 rounded-t-lg outline outline-1 outline-gray4 bg-gray2 placeholder-gray4 pl-5 pr-5" type="text" placeholder="Email"></input>
      <input id="password" class="mb-4 w-64 h-10 rounded-b-lg outline outline-1 outline-gray4 bg-gray2 placeholder-gray4 pl-5 pr-5" type="password" placeholder="Senha"></input>
      <button class="mb-4 w-56 h-10 bg-darkTeal rounded-lg" onClick={handleSubmit}><span class="text-white text-sm font-bold">Entrar</span></button>

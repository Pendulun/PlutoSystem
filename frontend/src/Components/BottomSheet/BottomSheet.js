...
export const BottomSheetContent = ({ Title, handleSubmit }) => (
  <div class="flex flex-col h-auto w-auto max-w-lg p-[50px] justify-center items-center mx-auto pb-[80px]">
    ...
    <input data-cy="tag" id="tag" class="w-full h-10 rounded-md outline outline-1 outline-gray4 bg-gray2 placeholder-gray4 pl-5 pr-5" type="text" placeholder="Tag" />
